...
hom.file = 'HOMOL/CI_KH_PM_HOM.txt'

sp1.blast.file = 'BLAST/PM_vs_CI_ghost_rm_besthitover_blastn_CI.gff'
...
sp2.blast.file = 'BLAST/PM_vs_CI_ghost_rm_besthitover_blastn_PM.gff'
sp2.ensg.file = 'ANNO/PM/PM_genes.txt'
sp2.ense.file = 'ANNO/PM/PM_exons.txt'
sp2.rfam.file = 'ANNO/PM/PM_1000bp_Rfam_PM.gff'
sp2.trna.file = 'ANNO/PM/PM.trnascan.out'
sp2.rep.file = NA
...
# Specific issue to accommodate the format of ids in ciona kh
sp1.res$fl.id = lapply(sp1.res$fl.id, function(x) gsub('KH2012:','',x))
